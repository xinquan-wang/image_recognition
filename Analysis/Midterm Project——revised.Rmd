...
scoreboard <- setorder(as.data.table(rbind(ridge.regression, knn, classification.tree, 
                                           svm, LR, RF, gbm, xgboost, lasso)), "Points")
datatable(scoreboard)


scoreboard.average <- setorderv(as.data.table(rbind(ridge.regression.summary, knn.summary, classification.tree.summary, 
                                                    svm.summary, LR.summary, RF.summary, gbm.summary, xgboost.summary, 
                                                    lasso.summary)), "Points")
